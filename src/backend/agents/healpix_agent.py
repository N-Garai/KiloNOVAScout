...
healpix_agent = Agent(
    name="HEALPixSpatialAgent",
    system_prompt="You are an astrometry specialist calculating 3D gravitational-wave localization volumes.",
    tools=[process_healpix_skymap]
)